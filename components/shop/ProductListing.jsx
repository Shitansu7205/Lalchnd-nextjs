...
function ProductListingContent({ defaultLayout = 4 }) {
            ...
            <div className="container-full-2">
                    ...
                    <div className="tf-group-layout">
                        ...
                        <div className="tf-dropdown-sort" data-bs-toggle="dropdown">
                            <div className="btn-select">
                                <span className="text-sort-value">{sort}</span>
                            ...
                            <div className="dropdown-menu">
                                {[
                                    ...
                                    <div
                                        ...
                                        key={option}
                                        className={`select-item ${sort === option ? "active" : ""}`}
                                    >
                ...
                <div className="wrapper-control-shop gridLayout-wrapper">
                    <div
                        ...
                        id="gridLayout"
                    >
                        {loading && <div className="wd-full"><LoadingSpinner label="Loading products..." /></div>}
                        {!loading && error && (
                            <div className="wd-full text-center product-fetch-message">
                        ...
                        {sortedProducts.map((product) => (
                            <div
                                key={product.id}
                                className={`loadItem card_product--V01 grid ${product.outOfStock ? "out-of-stock" : ""}`}
                            >
