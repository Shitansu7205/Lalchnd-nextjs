...
export default function BrahmapurDescription() {
    return (
                                    ...
                                    <ul>
                                        <li className="post-review-item">
                                            ...
                                            <div className="rv-content">
                                                <div className="d-flex align-items-center justify-content-between flex-wrap">
                                                    <ul className="meta">
                                                        <li className="entry_name h6">Banita Panda</li>
                                        ...
                                        <li className="post-review-item">
                                            ...
                                            <div className="rv-content">
                                                <div className="d-flex align-items-center justify-content-between flex-wrap">
                                                    <ul className="meta">
                                                        <li className="entry_name h6">DINESH KUMAR</li>
                                                        <li className="br-line" />
                                                        <li className="entry_date">Mar 3rd, 2025</li>
                                                    </ul>
                                                    <ul className="rate-wrap align-items-center" style={{ color: "#f5c518" }}>
