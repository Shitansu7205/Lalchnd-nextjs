...
export default function Testimonials() {
  return (
    <section className="themesFlat">
      <div
        className="flat-spacing-7 parallaxie deep-bg"
      >
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 col-md-12">
              <div className="wow fadeInUp review-content">
                ...
                <Link
                  href="https://www.google.com/maps/place/Lalchnd+Jewellers/@20.2691643,85.8415713,17z/data=!4m8!3m7!1s0x3a19a744227e1903:0xb7b54fad41895a76!8m2!3d20.2691643!4d85.8415713!9m1!1b1!16s%2Fg%2F11g1lmdlp6!5m1!1e1?entry=ttu&g_ep=EgoyMDI2MDkxNi4wIKXMDSoASAFQAw%3D%3D"
                  className="border-cta-btn tf-btn btn-fill animate-btn review-btn"
                >
                  <span>Write Your Review</span>

                  <Image src="/images/lalchnd/icons/google.png" height={20} width={20} alt="Googleicons" />
                              ...
                              >
                                <g>
                                  ...
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M3.76447 5.95293L6.7684 8.96238C6.83841 9.03263 6.87772 9.12776 6.87772 9.22694C6.87772 9.32612 6.83841 9.42126 6.7684 9.49151L6.29439 9.96553C6.22413 10.0355 6.129 10.0748 6.02982 10.0748C5.93064 10.0748 5.8355 10.0355 5.76525 9.96553L2.7558 6.96159C2.68579 6.89134 2.64648 6.7962 2.7558 6.43246L3.23533 5.95844C3.30558 5.88843 3.40072 5.84912 3.4999 5.84912C3.59908 5.84912 3.69421 5.88292 3.76447 5.95293Z"
                                    fill="white"
                                  />
                                </g>
                              </svg>
